...
export default function Home() {
  ...
  const translations = {
    en: {
      ...
      description: 'Sellio is a revolutionary website and app that simplifies e-commerce and selling. It automatically responds to customers, shows them products, explains all details, takes shipping information, creates orders, and handles shipping - all while you relax and just post on your social media pages.',
      features: {
        products: {
      ...
      question: 'Do you think Sellio would be useful for you as a store owner?',
      options: {
      ...
      feedbackPlaceholder: 'What do you think about Sellio? What features interest you most?',
      ...
      tryNow: 'Want to try Sellio now?',
      discountSection: {
        title: '🎉 Exclusive Launch Discount!',
        subtitle: 'Be among the first to experience Sellio',
    ...
    ar: {
      ...
      description: 'Sellio هو موقع وتطبيق ثوري يبسط التجارة الإلكترونية والبيع. يرد تلقائياً على العملاء، ويعرض لهم المنتجات، ويشرح جميع التفاصيل، ويأخذ معلومات الشحن، وينشئ الطلبات، ويتولى الشحن - كل هذا وأنت مستريح وتنشر فقط على صفحاتك الاجتماعية.',
      features: {
        products: {
      ...
      question: 'هل تعتقد أن Sellio سيكون مفيداً لك كصاحب متجر؟',
      options: {
      ...
      feedbackPlaceholder: 'ما رأيك في Sellio؟ ما الميزات التي تهمك أكثر؟',
      submit: 'إرسال رأيك',
      ...
      tryNow: 'تريد تجربة Sellio الآن؟',
      discountSection: {
        title: '🎉 خصم حصري عند الإطلاق!',
        subtitle: 'كن من أوائل من يجرب Sellio',
